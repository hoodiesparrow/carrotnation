...
stages {
    ...
    stage('Docker run') {
        ...
        steps{
            ...
            sh 'docker run -d --name crawlingbe -p 8080:8080 -v /home/ubuntu/pemkey/:/home/ubuntu/pemkey/ -v  /home/ubuntu/mysqltablefile/:/home/ubuntu/mysqltablefile/ crawlingbe:latest '
